...
Expert 阅读原始制品、挑战记录和验证证据，对技术内容作 `pass`、`rework`、`blocked` 或 `needs-user` 结论，指出未关闭问题和最小修正。Expert 是核心内容裁决者，不是 Lead 的意见附件；Expert 若是制品 Owner，必须由另一位非作者 Expert 或满足要求的独立专家复核。
